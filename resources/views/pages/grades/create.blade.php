@extends('layouts.app', ['activePage' => 'grades', 'titlePage' => __('Create Grade')])
                    ...
                    <form method="post" action="{{ route('grades.store') }}" autocomplete="off" class="form-horizontal">
                        ...
                        <div class="card ">
                            <div class="card-header card-header-primary">
                                <h4 class="card-title">{{ __('Create Grade') }}</h4>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('grade') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('grade') ? ' is-invalid' : '' }}" name="grade" id="input-name" type="text" placeholder="{{ __('Grade') }}" value="{{ old('grade') }}" required="true" aria-required="true"/>
                                            @if ($errors->has('grade'))
