@extends('layouts.app', ['activePage' => 'units', 'titlePage' => __('Exploring Unit')])
                    ...
                    <div class="card">
                        <div class="card-header card-header-primary">
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <a class="round-button-filled float-right" href="{{ route('units.create') }}"><i class="material-icons">add</i></a>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
