@extends('layouts.app', ['activePage' => 'lessons', 'titlePage' => __('Create Lesson')])
...
@section('content')
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <form method="post" action="{{ route('lessons.store') }}" autocomplete="off" class="form-horizontal">
                        @csrf

                        <div class="card ">
                            <div class="card-header card-header-primary">
                                <h4 class="card-title">{{ __('Create Lesson') }}</h4>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('lesson') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('lesson') ? ' is-invalid' : '' }}" name="lesson" id="input-lesson" type="text" placeholder="{{ __('Lesson') }}" value="{{ old('lesson') }}" required="true" aria-required="true"/>
