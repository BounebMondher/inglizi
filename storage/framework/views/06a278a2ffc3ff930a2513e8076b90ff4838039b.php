...
<?php $__env->startSection('content'); ?>
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <form method="post" action="<?php echo e(route('sections.update', ['id' => $section['id']])); ?>" autocomplete="off" class="form-horizontal">
                        <?php echo csrf_field(); ?>

                        <div class="card ">
                            <div class="card-header card-header-primary">
                                <h4 class="card-title"><?php echo e(__('Edit Section')); ?></h4>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group<?php echo e($errors->has('section') ? ' has-danger' : ''); ?>">
                                            <input class="form-control<?php echo e($errors->has('section') ? ' is-invalid' : ''); ?>" name="section" id="input-section" type="text" placeholder="<?php echo e(__('Section')); ?>" value="<?php echo e(old('section', $section['section'])); ?>" required="true" aria-required="true"/>
                                        ...
                                        <div class="<?php echo e($errors->has('unit') ? ' has-danger' : ''); ?>">
                                            <select class="<?php echo e($errors->has('unit') ? ' is-invalid' : ''); ?>" name="unit" data-live-search="true" id="input-unit-lessons">
                                                <?php $__currentLoopData = $units; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option <?php echo e($unit['id'] == $sectionLesson['unit_id'] ? "selected" : ""); ?> value="<?php echo e($unit['id']); ?>"><?php echo e($unit['unit']); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                            ...
                                            <div class="<?php echo e($errors->has('lesson') ? ' has-danger' : ''); ?>">
                                                <select class="<?php echo e($errors->has('lesson') ? ' is-invalid' : ''); ?>" name="lesson" data-live-search="true" id="input-unit-lesson-sections">
                                                    <?php $__currentLoopData = $lessons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lesson): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option <?php echo e($lesson['id'] == $section['lesson_id'] ? "selected" : ""); ?> value="<?php echo e($lesson['id']); ?>"><?php echo e($lesson['lesson']); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-7">
                                            <div class="form-group">
                                                <input class="form-control" name="enabled" id="input-enabled" type="checkbox" <?php echo e($section['enabled'] ? "checked" : ""); ?> />
                                            </div>
                                        </div>
                                    </div>
...
<?php echo $__env->make('layouts.app', ['activePage' => 'sections', 'titlePage' => __('Edit Section')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp72\htdocs\inglizi\resources\views/pages/sections/edit.blade.php ENDPATH**/ ?>