...
<?php $__env->startSection('content'); ?>
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <form method="post" action="<?php echo e(route('units.update', ['id' => $unit['id']])); ?>" autocomplete="off" class="form-horizontal">
                        <?php echo csrf_field(); ?>

                        <div class="card ">
                            <div class="card-header card-header-primary">
                                <h4 class="card-title"><?php echo e(__('Edit Unit')); ?></h4>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group<?php echo e($errors->has('unit') ? ' has-danger' : ''); ?>">
                                            <input class="form-control<?php echo e($errors->has('unit') ? ' is-invalid' : ''); ?>" name="unit" id="input-unit" type="text" placeholder="<?php echo e(__('Unit')); ?>" value="<?php echo e(old('unit', $unit['unit'])); ?>" required="true" aria-required="true"/>
                                        ...
                                        <div class="<?php echo e($errors->has('grade') ? ' has-danger' : ''); ?>">
                                            <select class="<?php echo e($errors->has('grade') ? ' is-invalid' : ''); ?>" name="grade" data-live-search="true" id="input-grade">
                                                <?php $__currentLoopData = $grades; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $grade): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option <?php echo e($grade['id'] == $unit['grade_id'] ? "selected" : ""); ?> value="<?php echo e($grade['id']); ?>"><?php echo e($grade['grade']); ?></option>
...
<?php echo $__env->make('layouts.app', ['activePage' => 'units', 'titlePage' => __('Edit Unit')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp72\htdocs\inglizi\resources\views/pages/units/edit.blade.php ENDPATH**/ ?>