...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    ...
    <title><?php echo e(__('INGLIZI Dashboard')); ?></title>
    ...
    <link href="<?php echo e(asset('material')); ?>/css/plugins/bootstrap-select.min.css" rel="stylesheet" />
    <link href="<?php echo e(asset('css')); ?>/custom.css" rel="stylesheet" />
    <link href="<?php echo e(asset('css')); ?>/summernote.css" rel="stylesheet" />
    </head>
    <body class="<?php echo e($class ?? ''); ?> c">
...
</html><?php /**PATH C:\xampp72\htdocs\inglizi\resources\views/layouts/app.blade.php ENDPATH**/ ?>