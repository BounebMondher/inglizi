...
<?php $__env->startSection('content'); ?>
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <form method="post" action="<?php echo e(route('lessons.store')); ?>" autocomplete="off" class="form-horizontal">
                        <?php echo csrf_field(); ?>

                        <div class="card ">
                            <div class="card-header card-header-primary">
                                <h4 class="card-title"><?php echo e(__('Create Lesson')); ?></h4>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group<?php echo e($errors->has('lesson') ? ' has-danger' : ''); ?>">
                                            <input class="form-control<?php echo e($errors->has('lesson') ? ' is-invalid' : ''); ?>" name="lesson" id="input-lesson" type="text" placeholder="<?php echo e(__('Lesson')); ?>" value="<?php echo e(old('lesson')); ?>" required="true" aria-required="true"/>
...
<?php echo $__env->make('layouts.app', ['activePage' => 'lessons', 'titlePage' => __('Create Lesson')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp72\htdocs\inglizi\resources\views/pages/lessons/create.blade.php ENDPATH**/ ?>